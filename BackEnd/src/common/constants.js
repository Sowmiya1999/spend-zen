...
//registration
export const INPUT_NOT_FOUND_ERROR_MESSAGE = "Necessary Input Data Not Found";
export const USER_ALREADY_EXIST_ERROR_MESSAGE = "User Already Exist";
...
//addIncome
export const ADD_INCOME_FAILED_ERROR_MESSAGE = "Add Income Failed";

//getAllIncome
export const GET_INCOME_FAILED_ERROR_MESSAGE = "Income Data Fetch Failed";
